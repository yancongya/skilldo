export const resources = {
  en: {
    translation: {
      ...
      originRulesHint:
        'Use these rules to classify Git skills. Separate entries with commas or new lines.',
      originRules: {
        myGitOwners: 'My Git owners',
        myGitOwnersHint: 'GitHub owners or organizations that should be treated as yours.',
        myGitRepos: 'My Git repositories',
        myGitReposHint: 'Exact repositories, for example yancongya/OH-WorkSpace.',
  ...
  zh: {
    translation: {
      ...
      originRulesHint: '使用这些规则分类 Git Skills。可用逗号或换行分隔。',
      originRules: {
        myGitOwners: '我的 Git 所有者',
        myGitOwnersHint: '应视为你自己的 GitHub 用户或组织。',
        myGitRepos: '我的 Git 仓库',
        myGitReposHint: '精确仓库，例如 yancongya/OH-WorkSpace。',
