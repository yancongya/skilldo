export const resources = {
  en: {
    translation: {
      ...
      originRulesHint:
        'Owners in "My Git owners" are auto-classified as "mine" (push enabled). Official repo rules identify official sources.',
      originRules: {
        myGitOwners: 'My Git owners',
        myGitOwnersHint: 'GitHub user/org logins whose repos are classified as "mine" (push enabled).',
        myGitRepos: 'My Git repositories',
        myGitReposHint: 'Specific owner/repo pairs classified as "mine" (push enabled). Format: owner/repo.',
        officialGitRepos: 'Official Git repositories',
        officialGitReposHint: 'Repositories that should always be treated as official.',
        discoveredOwners: 'Discovered GitHub owners',
        discoveredOwnersHint: 'Owners found in your GitHub repos. Click to add to "My Git owners".',
        addAsMyOwner: 'Add as my owner',
        noGithubToken: 'Set a GitHub token above to discover your repos.',
      ...
      webdavBackupStatus: {
        pending: 'Backup status: not checked yet',
        success: 'Last backup: successful',
        failed: 'Last backup: failed',
      },
      syncNow: 'Sync',
      syncPulling: 'Pulling from WebDAV…',
      syncUpdatingSkills: 'Checking and updating local Skills…',
      syncSkillsUpdated: 'Updated {{count}} local Skill(s).',
      syncPushing: 'Pushing to WebDAV…',
      syncDone: 'Sync complete.',
      syncDoneNoBackup: 'Sync complete (database backup skipped).',
      exportToFile: 'Export to file',
      syncState: 'State',
      syncPushable: 'Pushable repos',
      syncDirty: 'Dirty repos',
      syncPullable: 'Pullable skills',
      ...
      currentAuthorName: 'Display name',
      currentAuthorEmail: 'Email',
      currentAuthorGithubLogin: 'GitHub login',
      currentAuthorGithubUrl: 'GitHub profile URL',
      currentAuthorNamePlaceholder: 'Your name',
      currentAuthorEmailPlaceholder: 'you@example.com',
      currentAuthorGithubLoginPlaceholder: 'octocat',
      currentAuthorGithubUrlPlaceholder: 'https://github.com/octocat',
      webdavConfig: 'WebDAV connection',
      localFile: 'Local file',
      webdavBackup: 'WebDAV',
      syncSectionTitle: 'Cross-device sync',
      advancedTools: 'Advanced tools',
      webdavReaderTitle: 'WebDAV Backup Viewer',
      webdavReaderHint: 'Connect to a WebDAV server to view backup data. Enter the direct URL to your SkillDo backup JSON file.',
      webdavConnect: 'Connect',
      webdavConnecting: 'Connecting…',
      webdavBackupOverview: 'Backup Overview',
      webdavReaderSkills: 'Skills',
      webdavReaderTools: 'Tools',
      webdavReaderVersion: 'Version',
      webdavReaderExportedAt: 'Exported',
      webdavReaderConfig: 'Configuration',
      ...
      profileSyncHint:
        'Merge the portable skill list through WebDAV, pull Git updates, and apply targets available on this computer. Local paths and credentials stay on this device.',
      profileStatus: 'Check profile',
      deviceSyncTitle: 'Quick cross-device sync',
      deviceSyncHint: 'Pull applies the state from WebDAV. Publish refreshes sources, pushes your owned repositories, then uploads the Profile and lossless backup.',
      deviceStatus: 'Check device state',
      devicePull: 'Get updates from other devices',
      devicePublish: 'Publish to other devices',
      deviceWorking: 'Working…',
      devicePublishConfirm: 'This may commit and push changes in repositories identified as yours, then update WebDAV. Continue?',
      deviceSummary: 'State: {{state}} · pushable repos {{pushable}} · dirty repos {{dirty}} · pullable Skills {{pullable}} · failures {{failures}}',
      profileAdvancedTitle: 'Advanced Profile tools',
      profileSyncNow: 'Sync now',
      profileSyncing: 'Syncing…',
      profileSyncDone: 'Profile synchronization completed.',
      profileConflictsFound: '{{count}} profile conflict(s) require attention.',
      profileApplyDeletions: 'Apply {{count}} deletion(s)',
      profileApplyDeletionsConfirm:
        'This removes skills deleted on another synchronized computer, including their central copies and targets. Continue?',
      profileExport: 'Export profile',
      profileImport: 'Import profile',
      profileExportDone: 'Profile exported.',
      profileImportDone: 'Profile imported.',
      profileUseLocal: 'Resolve with local',
      profileUseRemote: 'Resolve with remote',
      profileResolved: 'Profile conflicts resolved and synchronized.',
      profileDevice: 'Device ID',
      profileSyncSummary:
      ...
      restoreDone: 'Restore completed: {{summary}}',
      localSkillBadge: 'Local',
      localSkillTooltip:
        'Local skill — cannot be synced remotely (no Git/NPM source).',
      filterAll: 'All',
      filterSyncable: 'Syncable',
      filterLocal: 'Local only',
      filters: 'Filters',
      filtersActive: 'Filters · {{count}}',

      publishToGithub: 'Publish to GitHub',
      publishSkillTitle: 'Publish skill to GitHub',
      publishSkillSubtitle: 'Create a new repository and push this local skill to it.',
      publishRepoName: 'Repository name',
      publishOwner: 'Owner',
      publishOwnerHint: 'Leave empty to use your GitHub account from the configured token.',
      publishPrivate: 'Private repository',
      repoPrivate: 'Private',
      repoPublic: 'Public',
      publishMessage: 'Commit message',
      publishConfirm: 'Publish',
      publishSuccess: '{{name}} published → {{url}}',
      publishMissingToken: 'GitHub token is not configured. Set it in Settings first.',

      statusOverview: 'Tool status',
      statusOverviewHint: 'Installed status of all {{count}} supported AI tools.',
      toolFilters: 'Tool filters',
      hideInstalledTools: 'Hide installed',
      hideConfiguredTools: 'Hide custom directories',
      toolFilterCount: '{{visible}} of {{total}} tools shown',
  ...
  zh: {
    translation: {
      ...
      originRulesHint: '添加到「我的 Git 所有者」的作者，其仓库自动分类为"我的"（可推送）。官方仓库规则用于区分官方来源。',
      originRules: {
        myGitOwners: '我的 Git 所有者',
        myGitOwnersHint: 'GitHub 用户/组织名，其仓库自动分类为"我的"（可推送）。',
        myGitRepos: '我的 Git 仓库',
        myGitReposHint: '指定 owner/repo 对，分类为"我的"（可推送）。格式：owner/repo。',
        officialGitRepos: '官方 Git 仓库',
        officialGitReposHint: '始终视为官方来源的仓库。',
        discoveredOwners: '发现的 GitHub 作者',
        discoveredOwnersHint: '从你的 GitHub 仓库中发现的作者/组织，点击添加为"我的所有者"。',
        addAsMyOwner: '设为我的作者',
        noGithubToken: '请先设置 GitHub token 以发现你的仓库。',
        repoCount: '{{count}} 个仓库',
      },
      ...
      syncNow: '同步',
      syncPulling: '正在从 WebDAV 拉取…',
      syncUpdatingSkills: '正在检查并更新本地 Skills…',
      syncSkillsUpdated: '已更新 {{count}} 个本地 Skills。',
      syncPushing: '正在推送到 WebDAV…',
      syncDone: '同步完成。',
      syncDoneNoBackup: '同步完成（数据库备份跳过）。',
      exportToFile: '导出到本地',
      syncState: '状态',
      syncPushable: '可推送仓库',
      syncDirty: '有修改仓库',
      syncPullable: '可拉取 Skills',
      syncFailures: '失败',
      deviceRefresh: '刷新状态',
      ...
      currentAuthorName: '显示名称',
      currentAuthorEmail: '邮箱',
      currentAuthorGithubLogin: 'GitHub 登录名',
      currentAuthorGithubUrl: 'GitHub 个人主页',
      currentAuthorNamePlaceholder: '你的名字',
      currentAuthorEmailPlaceholder: 'you@example.com',
      currentAuthorGithubLoginPlaceholder: 'octocat',
      currentAuthorGithubUrlPlaceholder: 'https://github.com/octocat',
      ...
      advancedTools: '高级工具',
      webdavReaderTitle: 'WebDAV 备份查看器',
      webdavReaderHint: '连接 WebDAV 服务器查看备份数据。请输入 SkillDo 备份 JSON 文件的直接 URL。',
      webdavConnect: '连接',
      webdavConnecting: '连接中…',
      webdavBackupOverview: '备份概览',
      webdavReaderSkills: '技能',
      webdavReaderTools: '工具',
      webdavReaderVersion: '版本',
      webdavReaderExportedAt: '导出时间',
      webdavReaderConfig: '配置信息',
      ...
      profileSyncHint:
        '通过 WebDAV 合并可移植 Skill 清单、拉取 Git 更新，并应用当前电脑可用的目标工具。本机路径和凭据不会离开当前设备。',
      profileStatus: '检查 Profile',
      deviceSyncTitle: '快捷跨设备同步',
      deviceSyncHint: '“获取”会应用 WebDAV 中的状态；“发布”会先更新来源并推送属于你的仓库，然后上传 Profile 和无损备份。',
      deviceStatus: '检查设备状态',
      devicePull: '获取其他设备更新',
      devicePublish: '发布到其他设备',
      deviceWorking: '正在处理…',
      devicePublishConfirm: '此操作可能会提交并推送被识别为属于你的仓库，然后更新 WebDAV。是否继续？',
      deviceSummary: '状态：{{state}} · 可推送仓库 {{pushable}} · 有修改仓库 {{dirty}} · 可拉取 Skills {{pullable}} · 失败 {{failures}}',
      profileAdvancedTitle: 'Profile 高级工具',
      profileSyncNow: '立即同步',
      profileSyncing: '同步中…',
      profileSyncDone: 'Profile 同步完成。',
      profileConflictsFound: '发现 {{count}} 个需要处理的 Profile 冲突。',
      profileApplyDeletions: '应用 {{count}} 项删除',
      profileApplyDeletionsConfirm:
        '这会删除其他同步电脑已删除的 Skills，包括中央副本和同步目标。确定继续吗？',
      profileExport: '导出 Profile',
      profileImport: '导入 Profile',
      profileExportDone: 'Profile 已导出。',
      profileImportDone: 'Profile 已导入。',
      profileUseLocal: '使用本机解决',
      profileUseRemote: '使用远端解决',
      profileResolved: 'Profile 冲突已解决并同步。',
      profileDevice: '设备 ID',
      profileSyncSummary:
      ...
      backupDone: '备份完成。',
      restoreDone: '恢复完成：{{summary}}',
      localSkillBadge: '本地',
      localSkillTooltip: '本地技能 —— 没有 Git/NPM 来源，无法远程同步。',
      filterAll: '全部',
      filterSyncable: '可同步',
      filterLocal: '仅本地',
      filters: '筛选',
      filtersActive: '筛选 · {{count}}',

      publishToGithub: '发布到 GitHub',
      publishSkillTitle: '发布技能到 GitHub',
      publishSkillSubtitle: '创建一个新的仓库，并将此本地技能推送到该仓库。',
      publishRepoName: '仓库名称',
      publishOwner: '所有者',
      publishOwnerHint: '留空则使用所配置 Token 对应的 GitHub 账号。',
      publishPrivate: '私有仓库',
      repoPrivate: '私有',
      repoPublic: '公开',
      publishMessage: '提交说明',
      publishConfirm: '发布',
      publishSuccess: '{{name}} 已发布 → {{url}}',
      publishMissingToken: '尚未配置 GitHub Token，请先在设置中配置。',

      statusOverview: '工具状态',
      statusOverviewHint: '全部 {{count}} 个受支持 AI 工具的已安装状态。',
      toolFilters: '工具筛选',
      hideInstalledTools: '隐藏已安装',
      hideConfiguredTools: '隐藏已自定义目录',
      toolFilterCount: '显示 {{visible}} / {{total}} 个工具',
      statusInstalled: '已安装',
