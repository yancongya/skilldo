export const resources = {
  en: {
    translation: {
      ...
      webdavHint:
        'Configure a WebDAV server to back up settings, skills, and sync targets remotely. Authentication credentials are never included in the backup file.',
  ...
  zh: {
    translation: {
      ...
      webdav: 'WebDAV 备份',
      webdavHint: '配置 WebDAV 服务器，用于远程备份设置、Skills 与同步目标。身份凭据不会写入备份文件。',
      webdavUrl: '服务器地址',
      webdavUser: '用户名',
      webdavPassword: '密码',
